...
//! | `KHR_texture_basisu`              | ✅\†     | `ktx2`, `basis-universal`           |
...
//!
//! \†`KHR_texture_basisu` is read by the loader; the actual image decoding requires the `ktx2` and `basis-universal` cargo features to be enabled by the consuming crate.
//!
